...
public class FlyCmd extends CommandExecute implements Listener, CommandExecutor {
	...
	static SurvivalFly plugin = SurvivalFly.getPlugin(SurvivalFly.class);
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase("parkourfly") && player instanceof Player) {
		...
		if (cmd.getName().equalsIgnoreCase("test") && player instanceof Player) {
			if (args.length == 0) {
